    ...
    <div className="h-screen flex justify-center items-center">
      <div>
        {path == "/register" ? (
          ...
          <>
            <div
              className={`border rounded-lg text-center w-[350px] h-[412px] ${segoeui.variable} ${billabong.variable} `}
            >
              {children}
            </div>
          </>
        ...
        {path == "/register" ? (
          ...
          <>
            <div className="border mt-3 w-[348px] rounded-lg text-center py-5">
              {" "}
